...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.00295787880;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES =  0.003025149474;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.00288190239;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-9.4/25.4 - 0.1, 164.4/25.4, 0);
        rightEncoderPose = new Pose(-12.7/25.4 - 0.1, -171.45/25.4, 0);
        strafeEncoderPose = new Pose(-177.8/25.4 +.25,1/25.4-0.23, Math.toRadians(90));
