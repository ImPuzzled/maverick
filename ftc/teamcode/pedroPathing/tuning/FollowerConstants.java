...
public class FollowerConstants {
    ...
    private static double xMovement = 50.308173595722465;
    private static double yMovement = 69.68487543520015;
    ...
    public static double mass = 9.98;
    ...
    // this is for curves
    public static double forwardZeroPowerAcceleration = -44.42276614570126;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -152.16473637448016;
